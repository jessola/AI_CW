...
class ReturningRules:
    ...
    # 'Return Condition' Specified
    @Rule(Fact(return_condition=MATCH.ret_condition))
    def return_condition_answered(self, ret_condition):
        self.remaining_questions.remove("return_condition")
